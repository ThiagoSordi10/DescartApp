...
from .views import DemandCreateView, DemandDeleteView, DemandListView, DemandUpdateView, DemandAddressesView, DemandUpdateStatusView, AdressCreateView, CollectOrdersListView, AddressListView, AddressUpdateView, AddressDeleteView
...
urlpatterns = [
    ...
    path('address/list/', AddressListView.as_view(), name="list_address"),
